...
<div class='background-image' style ="background-image:url('../assets/back1.jpg')">
    <div class="container">
  <div class="row">
    <div class="col-md-12 text-center"><img src="Assets/200.jpg" style ="height:400px"  width: "400px"></div>
  </div>
...
<!-- Inner Info-->
    <div class="page-header text-center", style='margin: 20px 0 0px;'>
      ...
      <a href="projects.aspx"><img src="../assets/projects4.jpg" alt="Responsive image" class="img-rounded" style = "height:140px" width: "600px"></a>
  
      <a href="services.aspx"> <img src= "../assets/services1.jpg" alt="Responsive image" class="img-rounded" style ="height:100px"  width: "50px"></a>
